...
def equation_2 (data, avg):
    '''Calls the avg() function in order to make it a 2-pass method.
    '''
    sum_2 = 0
    for i in data:
        sum_2 += i**2
    var_2 = 1/(n-1)*(sum_2 - n*avg**2)
    if var_2 < 0:
...
sigma_2a = equation_2 (a, average(a))
r_error_2a = (sigma_2a - std_a)/std_a

sigma_2b = equation_2 (b, average(b))
